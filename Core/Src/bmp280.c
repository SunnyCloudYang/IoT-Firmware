...
/**
 * Initialize BMP280 parameters with default values.
 */
...
/**
 * Read a 16-bit register from the BMP280.
 */
...
/**
 * Read calibration data from the BMP280.
 */
...
/**
 * Read humidity calibration data from the BME280.
 */
...
/**
 * Write an 8-bit register to the BMP280.
 */
...
bool bmp280_init(BMP280_HandleTypedef *dev, bmp280_params_t *params)
{
	...
	uint8_t ctrl = (params->oversampling_temperature << 5) |
				   (params->oversampling_pressure << 2) |
				   (params->mode);
...
/**
 * Force a measurement on the BMP280.
 */
...
/**
 * Check if the BMP280 is currently measuring.
 */
...
/**
 * Compensation algorithm for temperature.
...
/**
 * Compensation algorithm for pressure.
...
/**
 * Compensation algorithm for humidity.
 * Return value is in Pa, 24 integer bits and 8 fractional bits.
 */
...
/**
 * Read fixed-point temperature, pressure, and humidity from the BMP280.
 */
...
/**
 * Read floating-point temperature, pressure, and humidity from the BMP280.
 */
